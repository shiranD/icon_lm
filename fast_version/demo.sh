...
python3 $demodir/demo.py --data ${sets}/set_${foldchoice}/ --embd ${embeddingpath}/${emset}_${emdim}${kwd} --icon ${embeddingpath}/${emset}_${emdim}_icons${kwd} --load ${modelname}_${foldchoice}.pt --emsize $emdim --cuda --aug
